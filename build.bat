...
echo Compiling tester.exe...
g++ -std=c++11 -o tester.exe msr_tester.cpp msr_reader.cpp msr_writer.cpp msr_common.o -L. -lMSR_API -luser32
if %errorlevel% neq 0 (
    echo Compilation of tester.exe failed.
    exit /b %errorlevel%
)
echo Compilation of tester.exe successful.
